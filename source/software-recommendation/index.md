...
- [Jetbrains](https://www.jetbrains.com.cn)
  - [AppCode](https://www.jetbrains.com.cn/objc/) - 苹果开发
  - [Aqua](https://www.jetbrains.com.cn/aqua/) - 自动化测试
  - [CLion](https://www.jetbrains.com.cn/clion/) - C 和 C++ 跨平台 IDE
  - [DataGrip](https://www.jetbrains.com.cn/datagrip/) - 全能的数据库工具
  - [DataSpell](https://www.jetbrains.com.cn/dataspell/) - 专业数据科学家的 IDE
  - [Fleet](https://www.jetbrains.com.cn/fleet/) - 由 JetBrains 打造的下一代 IDE
  - [GoLand](https://www.jetbrains.com.cn/go/) - go 语言 IDE
  - [IntelliJ IDEA](https://www.jetbrains.com.cn/idea/) - 领先的 Java 和 Kotlin IDE
  - [PhpStorm](https://www.jetbrains.com.cn/phpstorm/) - 高效智能的 PHP IDE
  - [PyCharm](https://www.jetbrains.com.cn/pycharm/) - 面向专业开发者的 Python IDE
  - [Rider](https://www.jetbrains.com.cn/rider/) - 快速且强大的跨平台 .NET IDE
  - [RubyMine](https://www.jetbrains.com.cn/ruby/) - 最智能的 Ruby 与 Rails IDE
  - [WebStorm](https://www.jetbrains.com.cn/webstorm/) - 最智能的 JavaScript IDE
- [LiteIDE](http://liteide.org/cn/) - 开源 GO IDE
...
- [Blender](https://www.blender.org/) - 开源免费的 3D 建模软件
- [Axure RP](https://www.axure.com/) - 原型设计软件
- [Houdinni](https://www.sidefx.com/) - 特效、建模
- [Live2D Cubism](https://www.live2d.com/zh-CHS/) - Live2D Cubism 可以仅用一幅插画创建各种形式的动画
- [Luminar](https://skylum.com/hans/luminar) - 照片处理
- [C4D](https://www.maxon.net/en/cinema-4d) - 建模
- [OmniGraffle](https://www.omnigroup.com/omnigraffle) - 图表、快速原型设计
- [Origami Studio](https://origami.design/) - Design, animate, and prototype. All-in-one.
- [Room Arranger](https://www.roomarranger.com/index_cn.html) - 室内设计
- [SF符号](https://developer.apple.com/sf-symbols/) - ICON
